...
/* Represents the four quads that need to be created to render a book on a shelf. Contains a constructor that randomly
   ...
   every shelf in client-loaded chunks.
 */
...
public class BookModel {
    ...
    private final float DEPTH; // The depth of the book, as determined in the same way as above.

    private final float LEFT_EDGE;
    private final float RIGHT_EDGE;
    ...
    public BookModel(BookPosition bookPosition, Random random){
        ...
        boolean topShelf = bookPosition.getQuadrant() == ShelfQuadrant.ALPHA || bookPosition.getQuadrant() == ShelfQuadrant.BETA;
        ...
        this.COVER = getRandomSprite(bookPosition.PIXELS, random);
    ...
    public void emitBookQuads(QuadEmitter e, Function<SpriteIdentifier, Sprite> tg) {
        ...
        e.pos(1, RIGHT_EDGE, HEIGHT, Z_BACK_STOP);
        ...
        e.sprite(1, 0, HEAD_HORIZONTAL_OFFSET + PIXELS, 0);
        ...
        e.pos(3, LEFT_EDGE, SHELF, Z_BACK_STOP);
        ...
        e.pos(1, RIGHT_EDGE, HEIGHT, DEPTH);
        e.pos(2, RIGHT_EDGE, SHELF, DEPTH);
        e.pos(3, LEFT_EDGE, SHELF, DEPTH);
        // Sprite Coordinates:
        e.sprite(0, 0, 7, 0);
        e.sprite(1, 0, 7 + PIXELS, 0);
        ...
        e.pos(3, RIGHT_EDGE, SHELF, DEPTH);
        // Sprite coordinates:
        e.sprite(0, 0, 7 + PIXELS, 0);
        e.sprite(1, 0, 7 + PIXELS + 7, 0);
        e.sprite(2, 0, 7 + PIXELS + 7, 7);
        e.sprite(3, 0, 7 + PIXELS, 7);
