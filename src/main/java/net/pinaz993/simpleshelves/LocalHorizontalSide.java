 ...
 * This could have been a private enum, but I want to try out tests. Thus, I have no choice but to make it it's own file.
 */
enum LocalHorizontalSide {
    ...
    public static LocalHorizontalSide getLocalSide(Direction cardinalSide, Direction blockIsFacing) {
        ...
        else if (blockIsFacing == Direction.UP || blockIsFacing == Direction.DOWN)
